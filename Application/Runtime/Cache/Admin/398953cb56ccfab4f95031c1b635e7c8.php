            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/huizhan/index.php/Admin/Zhiyin/edit_zhi" class="form-horizontal m-t" id="commentForm" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo ($zy["id"]); ?>">
                            <div class="form-group">
                                <label class="col-sm-3 control-label">标题：</label>
                                <div class="col-sm-8">
                                    <input id="title" name="title" minlength="2" type="text" class="form-control" required="" aria-required="true" value="<?php echo ($zy["title"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">English：</label>
                                <div class="col-sm-8">
                                    <input id="ctitle" name="btitle" minlength="2" type="text" class="form-control" required="" aria-required="true" value="<?php echo ($zy["btitle"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">图片：</label>
                                <div class="col-sm-8">
                                    <input id="cpassword" type="file" class="form-control" name="file" required="" aria-required="true" value="<?php echo ($zy["img"]); ?>">
                                </div>
                            </div>
                            <div class="form-group">
