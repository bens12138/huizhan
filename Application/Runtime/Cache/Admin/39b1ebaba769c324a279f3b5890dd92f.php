                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <tr class="gradeX">
                                    ...
                                    <td><?php echo ($fri["btitle"]); ?></td>
                                    <td><?php echo ($fri["img"]); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$fri["add_time"])); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$fri["edit_time"])); ?></td>
                                    <td width="4%">
                                        <a href="/huizhan/index.php/Admin/Zhiyin/editZhi/id/<?php echo ($fri["id"]); ?>" class="btn btn-sm btn-outline btn-warning">修改</a>
                                    </td>
                                </tr>
                                <?php if(is_array($sec)): $s = 0; $__LIST__ = $sec;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($s % 2 );++$s;?><tr class="gradeX">
                                    ...
                                    <td><?php echo ($voo["btitle"]); ?></td>
                                    <td><img src="/huizhan/Public/Uploads/<?php echo ($voo["img"]); ?>" height="60px"></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$voo["add_time"])); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$voo["edit_time"])); ?></td>
                                    <td width="4%">
                                        <a href="/huizhan/index.php/Admin/Zhiyin/editZhi/id/<?php echo ($voo["id"]); ?>" class="btn btn-sm btn-outline btn-warning">修改</a>
                                    </td>
    ...
    <script>
        ...
        function del(id){ 
            parent.layer.confirm('您确定要删除它吗？', {
                ...
                $.ajax({
                    type:'post',
                    url:'/huizhan/index.php/Admin/Zhiyin/del_nav',
                    data:'nav_id='+id,
        ...
        function editStatus(id){
            $.ajax({
                type:'post',
                url:'/huizhan/index.php/Admin/Zhiyin/edit_status',
                data:'id='+id,
                success:function(data){
                    window.location.reload();
                }
