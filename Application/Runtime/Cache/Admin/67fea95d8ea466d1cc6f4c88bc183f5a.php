            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/huizhan/index.php/Admin/Zhanshi/edit_shi" class="form-horizontal m-t" id="commentForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    ...
                                    <textarea id="editor" name="cont" type="text/plain" style="height:400px;"><?php echo ($art["content"]); ?></textarea>
