            ...
            <div class="col-sm-6 col-sm-offset-3">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <form method="post" action="/huizhan/index.php/Admin/User/add_user" class="form-horizontal m-t" id="commentForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-8">
                                    <input id="cpassword" type="password" class="form-control" name="password" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
                                <label class="col-sm-3 control-label">确认密码：</label>
                                <div class="col-sm-8">
                                    <input id="crepassword" type="password" class="form-control" name="repassword" required="" aria-required="true">
                                </div>
                            </div>
                            <div class="form-group">
