            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a href="/huizhan/index.php/Admin/Zhanshi/addShi" class="btn btn-info">添加</a>
                        </div>
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <?php if(is_array($arc)): $k = 0; $__LIST__ = $arc;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="gradeX">
                                    <td class="tdd"><?php echo ($k); ?></td>
                                    <td><?php echo ($vo["title"]); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$vo["add_time"])); ?></td>
                                    <td><?php echo (date("Y-m-d H:i:s",$vo["edit_time"])); ?></td>
                                    <td width="8%">
                                        <a href="/huizhan/index.php/Admin/Zhanshi/editShi/id/<?php echo ($vo["id"]); ?>" class="btn btn-sm btn-outline btn-warning">修改</a>
    ...
    <script>
        ...
        function del(id){
            parent.layer.confirm('不再考虑一下吗?', {
                ...
                $.ajax({
                    type:'post',
                    url:'/huizhan/index.php/Admin/Zhanshi/del_shi',
                    data:'id='+id,
        ...
        function editStatus(id){
            ...
            $.ajax({
                type:'post',
                url:'/huizhan/index.php/Admin/Zhanshi/edit_status',
                data:'user_id='+id,
                success:function(data){
