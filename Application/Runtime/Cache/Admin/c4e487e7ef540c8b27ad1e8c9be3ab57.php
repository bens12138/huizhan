            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a href="/huizhan/index.php/Admin/Nav/addNav" class="btn btn-info">添加导航</a>
                        </div>
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <?php if(is_array($nav)): $k = 0; $__LIST__ = $nav;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($k % 2 );++$k;?><tr class="gradeX">
                                        <td><?php echo ($k); ?></td>
                                        ...
                                        <td width="8%">
                                            <a href="/huizhan/index.php/Admin/Nav/editNav/id/<?php echo ($vo["id"]); ?>" class="btn btn-sm btn-outline btn-warning">修改</a>
                                            <span class="btn btn-sm btn-outline btn-danger" id="del" onclick="del(<?php echo ($vo["id"]); ?>)">删除</span>
                                        </td>
                                    </tr>
                                    <?php if(is_array($vo["erji"])): $s = 0; $__LIST__ = $vo["erji"];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($s % 2 );++$s;?><tr class="gradeX">
                                        <td><?php echo ($k); ?>-<?php echo ($s); ?></td>
                                        ...
                                        <td width="8%">
                                            <a href="/huizhan/index.php/Admin/Nav/editNav/id/<?php echo ($voo["id"]); ?>" class="btn btn-sm btn-outline btn-warning">修改</a>
    ...
    <script>
        ...
        function del(id){ 
            parent.layer.confirm('您确定要删除它吗？', {
                ...
                $.ajax({
                    type:'post',
                    url:'/huizhan/index.php/Admin/Nav/del_nav',
                    data:'nav_id='+id,
        ...
        function editStatus(id){
            $.ajax({
                type:'post',
                url:'/huizhan/index.php/Admin/Nav/edit_status',
                data:'id='+id,
                success:function(data){
                    window.location.reload();
                }
