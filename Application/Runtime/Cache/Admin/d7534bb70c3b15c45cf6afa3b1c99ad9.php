            ...
            <div class="col-sm-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        <div class="">
                            <a href="/huizhan/index.php/Admin/Zhoubian/addNews" class="btn btn-info">添加文章</a>
                        </div>
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                <tr class="gradeX">
                                    ...
                                    <td width="4%">
                                        <a href="/huizhan/index.php/Admin/Zhoubian/editZhou/id/<?php echo ($fri["id"]); ?>" class="btn btn-sm btn-outline btn-warning">修改</a>
                                    </td>
                                </tr>
                                <!-- 栏目列表 -->
                                <?php if(is_array($sec)): $s = 0; $__LIST__ = $sec;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$voo): $mod = ($s % 2 );++$s;?><tr class="gradeX">
                                        ...
                                        <td width="8%">
                                            <a href="/huizhan/index.php/Admin/Zhoubian/editZhou/id/<?php echo ($voo["id"]); ?>" class="btn btn-sm btn-outline btn-warning">修改</a>
                                        </td>
                                    </tr>
                                    <!-- 文章列表 -->
                                    <?php if(is_array($voo['erji'])): $k = 0; $__LIST__ = $voo['erji'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vi): $mod = ($k % 2 );++$k;?><tr class="gradeX">
                                            ...
                                            <td width="8%">
                                                <a href="/huizhan/index.php/Admin/Zhoubian/editNews/id/<?php echo ($vi["id"]); ?>" class="btn btn-sm btn-outline btn-warning">修改</a>
    ...
    <script>
        ...
        function del(id){ 
            parent.layer.confirm('您确定要删除它吗？', {
                ...
                $.ajax({
                    type:'post',
                    url:'/huizhan/index.php/Admin/Zhoubian/del_nav',
                    data:'nav_id='+id,
        ...
        function delNew(id){ 
            parent.layer.confirm('您确定要删除它吗？', {
                ...
                $.ajax({
                    type:'post',
                    url:'/huizhan/index.php/Admin/Zhoubian/del_news',
                    data:'id='+id,
                    success:function(data){
                        if(data == 1){
                            parent.layer.msg('成功删除', {icon: 1});
        ...
        function editStatus(id){
            $.ajax({
                type:'post',
                url:'/huizhan/index.php/Admin/Zhoubian/edit_status',
                data:'id='+id,
                success:function(data){
                    window.location.reload();
                }
